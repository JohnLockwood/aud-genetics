...
* [ ] Complete the [genetics-foundations bridge](lessons/01-genomics-data-and-qc/genetics-foundations.md): connect chromosomes, loci, alleles, and genotypes, and explain the assumptions conveyed by “autosomal, diploid, biallelic.”
* [ ] Derive the sample minor-allele frequency for each synthetic variant, then learn how PLINK's `--maf` filter uses it.
