...
* [ ] Complete the [sample-MAF and `--maf` checkpoint](lessons/01-genomics-data-and-qc/README.md#fifth-checkpoint-sample-maf-and-plink-filtering): derive the sample minor-allele frequency for each synthetic variant, then predict and verify PLINK's boundary behavior. See the [lesson setup note](notes/2026-09-15-minor-allele-frequency-lesson.md).
