...
* [ ] Complete the [alternate-allele-frequency checkpoint](lessons/01-genomics-data-and-qc/README.md#fourth-checkpoint-alternate-allele-counts-and-frequencies): calculate counts and frequencies by hand, distinguish alternate from minor allele, and compare the results with PLINK's `.acount` and `.afreq` reports.
