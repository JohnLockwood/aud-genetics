...
* [ ] Complete the [missingness-filtering checkpoint](lessons/01-genomics-data-and-qc/README.md#third-checkpoint-filtering-on-missingness): predict and compare separate `--geno 0.20` and `--mind 0.20` runs, including the behavior of values exactly on the threshold.
