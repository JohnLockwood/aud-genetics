...
* [ ] Complete the [observed-genotype-frequency and HWE checkpoint](lessons/01-genomics-data-and-qc/README.md#sixth-checkpoint-observed-genotype-frequencies-and-hardy-weinberg-equilibrium): derive observed and expected genotype frequencies, compare them with PLINK's reports, and explain what an HWE test can and cannot establish. See the [lesson setup note](notes/2026-09-15-hwe-foundations-lesson.md).
